...
function parseLocationData($id,$data){
    ...
    */
    ...
    $day = $parts[0][0].$parts[0][1]."-".$parts[0][2].$parts[0][3]."-20".$parts[0][4].$parts[0][5];
    $time = $parts[1][0].$parts[1][1].":".$parts[1][2].$parts[1][3].":".$parts[1][4].$parts[1][5];
    $timestamp = strtotime($day." ".$time.' UTC');
