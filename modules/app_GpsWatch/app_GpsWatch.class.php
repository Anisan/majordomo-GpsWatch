...
* @version 0.1 (13:12:17 [Dec 07, 2016])
*/
//
//
class app_GpsWatch extends module {
    ...
    */
     ...
     */
    function uninstall() {
        SQLExec('DROP TABLE IF EXISTS gw_log');
        SQLExec('DROP TABLE IF EXISTS gw_cmd');
        SQLExec('DROP TABLE IF EXISTS gw_traffic');
        SQLExec('DROP TABLE IF EXISTS gw_settings');
        SQLExec('DROP TABLE IF EXISTS gw_device');
        parent::uninstall();
    }
